...
- Name: tests\template-test.spec.js >> Template Loader >> should load templates from includes folder
- Location: tests\template-test.spec.js:47:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/includes/modal-templates.html
Call log:
  - navigating to "http://localhost:8080/includes/modal-templates.html", waiting until "load"
